define("ace/snippets", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/lang", "ace/range", "ace/anchor", "ace/keyboard/hash_handler", "ace/tokenizer", "ace/lib/dom", "ace/editor"], function (e, t, n) {
    ...
    f.prototype = {
        setupContext: function (e) {
            ...
            var e = this.ace, t = e.getCursorPosition().row, n = e.session.getLine(t).length, r = e.session.doc.positionToIndex({
                row: t,
                column: 0
            });
            ...
            switch (this.getSyntax()) {
                ...
                default:
                    var t = this.ace.session.$mode;
                    return t.emmetConfig && t.emmetConfig.profile || "xhtml"
            }
        }, prompt: function (e) {
            return prompt(e)
            ...
            var t = 1e3, n = 0, r = null, i = u.require("range"), s = u.require("tabStops"), o = u.require("resources").getVocabulary("user"), a = {
                tabstop: function (e) {
    ...
    for (var h in l)t.commands.addCommand({
        name: "emmet:" + h,
        action: h,
        bindKey: l[h],
    ...
    var p = function (e, n) {
        ...
        typeof a == "string" && e("ace/config").loadModule(a, function () {
            a = null, t && t()
        })
    };
    t.AceEmmetEditor = f, e("ace/config").defineOptions(i.prototype, "editor", {
        enableEmmet: {
            set: function (e) {
