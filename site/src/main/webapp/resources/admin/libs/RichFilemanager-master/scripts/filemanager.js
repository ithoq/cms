...
fileConnector = '/admin/fileManager/api';
...
if($.urlParam('langCode') != 0) {
	...
	console.log(config.globals.pluginPath + '/scripts/languages/'  + $.urlParam('langCode') + '.json');
...
var formatBytes = function(bytes, round) {
	...
	console.log("Error in the connector, the size is NaN");
	return null;
};
