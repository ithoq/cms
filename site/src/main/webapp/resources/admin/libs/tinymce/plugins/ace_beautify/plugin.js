...
tinymce.PluginManager.add("ace_beautify", function(a) {
    function t() {
		...
		if($('#mce-ace-editor-body').length) {
			...
			mce_editor.setTheme("ace/theme/chrome");
    ...
    a.addCommand("mceace_codeEditor", t), a.addButton("ace_beautify", {
        icon: "code",
        tooltip: "Code Editor",
        onclick: t
    }), a.addMenuItem("ace_beautify", {
        icon: "code",
        text: "Code Editor",
        context: "tools",
        onclick: t
