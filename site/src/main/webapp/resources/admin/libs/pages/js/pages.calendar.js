    ...
    var PagesCalendar = function (element, options) {
        ...
        Calendar = {
            ...
            Init: function () {
                ...
                if (Calendar.settings.ui.year == null || Calendar.settings.ui.month == null || Calendar.settings.ui.date == null || Calendar.settings.ui.week == null || Calendar.settings.ui.grid == null) {
                ...
                if (!this.settings.weekends) {
                    this.Calendar.settings.ui.week.startOfTheWeek = 1;
                    this.Calendar.settings.ui.week.endOfTheWeek = 5;
                }
            ...
            _buildCurrentDateHeader: function () {
                $("#currentDate").text(moment([calendar.year, calendar.month, calendar.date]).format(Calendar.settings.ui.date.format));
            },
