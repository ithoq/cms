...
class GlobalExceptionController {
    ...
    private static ModelAndView handleException(final Exception e, HttpServletRequest request, final HttpServletResponse response, int sc, final String view, final String messageCode) {
