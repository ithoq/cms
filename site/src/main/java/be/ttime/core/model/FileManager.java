...
//
//   // private static String conenctorPath = "/in"
//
...
//        this.fileManagerRoot = " http://localhost:8080/resources/admin/libs/RichFilemanager-master/";
...
//
//
//        this.documentRoot = "webdata/upload/public";
//    }
//
...
//
//        this.item.put("preview", config.getProperty("icons-path") + "/" + config.getProperty("icons-default"));
//
//
...
//            this.item.put("preview", "/admin/fileManager/index.html?mode=preview&path=" + pathTmp);
...
//
//            try{
//                is = Thread.currentThread().getContextClassLoader().getResourceAsStream("filemanager.properties");
//                config = new Properties();
//                config.load(is);
//            }catch(Exception e){
//                error("Error loading config file");
